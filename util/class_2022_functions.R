...
#' 
#' @param x @param y one number you'd like to multiply
#' the other number you'd like to multiply
fun <- function(x, y) {
  ans <- x * y
  return(ans)
}
...
#' @description finds peak intersections
#' @param peak_list (see above)
...
#' @description get rid of peaks to non-canonical chromosomes
#' @params broad_peak_file and whether you want to filter to canonical chrs
...
#' @description 
#' @params filtered consensus peaks and promoters_gr
