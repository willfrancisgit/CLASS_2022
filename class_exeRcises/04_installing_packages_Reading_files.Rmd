...
5) Create a new folder called "analysis" (button bottom right pannel first tab on left)
...
peaks_per_dbp <- peaks_per_dbp %>% 
  mutate(genome_coverage_size = ifelse(tpl_m < 1, "small",
                          ifelse(tpl_m < 30, "medium", "large")))
