...
source("/scratch/Shares/rinnclass/CLASS_2022/wifr3145/CLASS_2022/util/class_2022_functions.R")
...
for(i in 1:length(consensus_peaks)) {
  rtracklayer::export(consensus_peaks[[i]], 
                      paste0("/scratch/Shares/rinnclass/CLASS_2022/wifr3145/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/consensus_peaks/", 
